...
// Representará la sección para poder actualizar el perfil del usuario
export default function Profile() {
    ...
    const formik = useFormik({
        ...
        // Implementando el método 'profileValidation' para realizar las validaciones
    ...
    // 'formik' no soporta la subida de archivos, por lo tanto es necesario la implementación del siguiente handler
